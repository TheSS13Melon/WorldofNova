...
/datum/morality/heaven
	...
	alignment = MORALITY_HUMANITY
	bearing_flags = BEARING_HOLINESS
...
/datum/morality/metamorphosis
	...
	alignment = MORALITY_ENLIGHTENMENT
	bearing_flags = BEARING_INHUMANITY
...
/datum/morality/heart
	...
	alignment = MORALITY_ENLIGHTENMENT
	bearing_flags = BEARING_INTELLECT
...
/datum/morality/typhon
	...
	alignment = MORALITY_ENLIGHTENMENT
	bearing_flags = BEARING_DEVOTION
...
/datum/morality/beast
	...
	alignment = MORALITY_ENLIGHTENMENT
	bearing_flags = BEARING_MENACE

/datum/morality/caine
	name = "Path of Caine"
	desc = "The Path of Caine is a Path of Enlightenment that emulates the Dark Father in order to ward off the Beast. Due to its strong ties with Noddism, it is almost exclusively found in the ranks of the Sabbat. Adherents are called Noddists."
	alignment = MORALITY_ENLIGHTENMENT
	bearing_flags = BEARING_FAITH
