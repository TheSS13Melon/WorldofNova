...
DEFINE_BITFIELD(bearing_flags, list(
	"BEARING_MUNDANE" = BEARING_MUNDANE,
	"BEARING_RESOLVE" = BEARING_RESOLVE,
	"BEARING_JUSTICE" = BEARING_JUSTICE,
	"BEARING_INHUMANITY" = BEARING_INHUMANITY,
	"BEARING_COMMAND" = BEARING_COMMAND,
	"BEARING_INTELLECT" = BEARING_INTELLECT,
	"BEARING_DEVOTION" = BEARING_DEVOTION,
	"BEARING_HOLINESS" = BEARING_HOLINESS,
	"BEARING_SILENCE" = BEARING_SILENCE,
	"BEARING_MENACE" = BEARING_MENACE,
	"BEARING_FAITH" = BEARING_FAITH,
	"BEARING_GUILT" = BEARING_GUILT,
))
