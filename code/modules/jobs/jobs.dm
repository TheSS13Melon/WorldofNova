...
GLOBAL_LIST_INIT(club_positions, list(
    "Club Manager",
    "Club Bouncer",
    "Club Worker"
))
...
GLOBAL_LIST_INIT(position_categories, list(
    ...
    EXP_TYPE_CLUB = list("jobs" = club_positions, "color" = "#ff69b4"),
...
GLOBAL_LIST_INIT(exp_jobsmap, list(
	EXP_TYPE_CREW = list("titles" = command_positions | church_positions | camarilla_council_positions | citizen_positions | police_positions | national_security_positions | anarch_positions | services_positions | club_positions | giovanni_positions | tzimisce_positions | warehouse_positions | tremere_positions | gang_positions | clinic_positions), // crew positions
    ...
    EXP_TYPE_CLUB = list("titles" = club_positions),
...
// Club Faction Jobs are now defined in their own files
